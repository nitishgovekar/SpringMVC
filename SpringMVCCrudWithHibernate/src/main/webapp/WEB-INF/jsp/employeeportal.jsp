			...
			<div class="modal-content">
					...
					<div class="modal-body">					
						<div class="form-group">
							<label>Name</label>
							<f:input path="name" name="name" type="text" class="form-control"></f:input>
						</div>
						<div class="form-group">
							<label>Email</label>
							<f:input path="email" name="email" type="email" class="form-control"></f:input>
						</div>
						<div class="form-group">
							<label>Address</label>
							<f:input path="address" name="address" type="text" class="form-control"></f:input>
						</div>
						<div class="form-group">
							<label>Phone</label>
							<f:input path="telephone" name="telephone" type="text" class="form-control"></f:input>
						</div>					
					</div>
			...
			<div class="modal-content">
				<f:form action="updateEmployee" method="post" modelAttribute="employee">
					...
					<div class="modal-body">					
						<div class="form-group">
							<label>Name</label>
							<f:input path="name" id="editName" type="text" class="form-control" value="" />
						</div>
						<div class="form-group">
							<label>Email</label>
							<f:input path="email" id="editEmail" type="email" class="form-control" value=""/>
						</div>
						<div class="form-group">
							<label>Address</label>
							<f:input path="address" id="editAddress" type="text" class="form-control" value="" />
						</div>
						<div class="form-group">
							<label>Phone</label>
							<f:input path="telephone" id="editTelephone" type="text" class="form-control" value="" />
						</div>		
						<div class="form-group">
